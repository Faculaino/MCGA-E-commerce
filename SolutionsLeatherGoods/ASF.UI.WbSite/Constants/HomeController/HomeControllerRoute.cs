namespace ASF.UI.WbSite.Constants.HomeController
{
    public static class HomeControllerRoute
    {
        ...
        public const string GetCategory = ControllerName.Category + "GetCategory";
        public const string GetClient = ControllerName.Client + "GetClient";
        public const string GetDealer = ControllerName.Dealer + "GetDealer";
        public const string GetCountry = ControllerName.Country + "GetCountry";
        public const string GetProduct = ControllerName.Product + "GetProduct";
    }
}